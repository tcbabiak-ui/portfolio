  ...
  const experiences = [
    {
      ...
      description: "I manage a portfolio of 50 accounts, working as the main technical advisor on cloud, security, and workplace projects. I partner with executives and technical teams to align roadmaps and drive adoption.",
      achievements: [
    ...
    },
    {
      ...
      description: "I was the main technical contact for mid-market and enterprise customers, helping them adopt cloud solutions and identify expansion opportunities.",
      achievements: [
    ...
    },
    {
      ...
      description: "I ran security onboarding and transition programs for new enterprise clients moving to managed services.",
      achievements: [
    ...
    },
    {
      ...
      description: "I worked my way up from L1 support to Senior Engineer to Jr. Network Administrator, handling escalations for Microsoft cloud and infrastructure issues.",
      achievements: [
    ...
    },
    {
      ...
      description: "I worked in a 24/7 NOC, handling incidents in real-time to keep broadcast systems running.",
      achievements: [
  ...
  return (
    <section id="experience" className="experience">
      <div className="section-header">
        ...
        <p className="section-subtitle">My career in technology and customer success</p>
      </div>
